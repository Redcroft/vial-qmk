...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_split_3x6_3_ex2(
				      ...
				      ESC_CTL, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,  RM_PREV,   RM_HUED,   KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_MNS,
  ...
  [_LOWER] = LAYOUT_split_3x6_3_ex2(
				    KC_TILD, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,     _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
